      ...
      <div className="my-container mx-auto px-4 pb-8">
        <div className="grid grid-cols-12 gap-8 pb-4 ">
          <div className="col-span-full md:col-span-6 lg:col-span-8 order-2">
            <img className="w-full aspect-video object-cover" src={fixImgUrl(newsData.stock[0].image_url)} alt={newsData.stock[0].title} onError={(e)=>updateBadImage(e)}/>
          ...
          <Link to={`/category/stock/${titleToSlug(newsData.stock[4].title)}`} className="gap-1 items-center grid grid-cols-5 border-b py-3">
            ...
            <img className="w-full border aspect-video col-span-full md:col-span-1 md:aspect-[9/12] object-cover" src={fixImgUrl(newsData.stock[4].image_url)} alt={newsData.stock[4].title} onError={(e)=>updateBadImage(e)}/>
            </Link>
            ...
            <img className="w-full border aspect-video col-span-full md:col-span-1 md:aspect-[9/12] object-cover" src={fixImgUrl(newsData.stock[5].image_url)} alt={newsData.stock[5].title} onError={(e)=>updateBadImage(e)}/>
            </Link>
