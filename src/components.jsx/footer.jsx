  ...
  return (
    <footer className="bg-secondry text-white py-10">
      <div className="my-container">
        ...
        <div className="flex items-end group-hover:rotate-45 relative group-hover:mix-blend-screen">
        <img
          src={logo}
        ...
        <img ref={newsPaperRef} src={dot} className="~w-8/12 group-hover:-rotate-[60deg] top-2 right-3" alt="" srcset="" />
        </div>
        </div>
        <span className="pirata-one-regular uppercase text-white ~text-6xl/7xl">
          news
        </span>
        </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className=" hover:text-primary"><i className="icofont-facebook"></i></a>
              <a href="#" className=" hover:text-primary"><i className="icofont-twitter"></i></a>
              <a href="#" className=" hover:text-primary"><i className="icofont-instagram"></i></a>
              <a href="#" className=" hover:text-primary"><i className="icofont-linkedin"></i></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/whats-new" className="hover:text-primary">What's New</Link></li>
              <li><Link to="/developers" className=" hover:text-primary">Developers</Link></li>
              <li><Link to="/releases" className="hover:text-primary">Releases</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/category/finance" className=" hover:text-primary">Finance</Link></li>
              <li><Link to="/category/business" className=" hover:text-primary">Business</Link></li>
              <li><Link to="/category/stocks" className=" hover:text-primary">Stocks</Link></li>
              <li><Link to="/category/crypto" className=" hover:text-primary">Crypto</Link></li>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className=" newsreader-500 text-center md:text-left">Copyright © Pegions.news {new Date().getFullYear()}. <br className='sm:hidden'/> All rights reserved</p>
          <div className="mt-4 md:mt-0">
            <Link to="/privacy-policy" className=" hover:text-primary mr-4">Privacy Policy</Link>
            <Link to="/terms-of-use" className=" hover:text-primary">Terms of Use</Link>
          </div>
        </div>
      </div>
    </footer>
